...
class PTR(BaseModel):
    ...
    def temporal_attn_fn(self, agents_emb, agent_masks, layer):
        ...
        # K,L,M = agent_masks.size()
        # agent_masks =agent_masks.reshape(K*M, L)
    ...
    def social_attn_fn(self, agents_emb, agent_masks, layer):
        ...
        # agent_masks = agent_masks.permute(2, 1, 0)
    
        # for t in range(agents_emb.size(1)):  # Looping over the time dimension
        #     if t < agents_emb.size(0):
        #         agents_emb[:, t] = layer(agents_emb[:, t], src_key_padding_mask=agent_masks[:, t])
